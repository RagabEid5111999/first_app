...
class _MyHomePageState extends State<MyHomePage> {
  ...
  /// This is list of age which will pass to the drop down
  final List<SelectedListItem<String>> _listOfAges = [
    SelectedListItem<String>(data: "10"),
    SelectedListItem<String>(data: "20"),
    SelectedListItem<String>(data: "25"),
    SelectedListItem<String>(data: "30"),
    SelectedListItem<String>(data: "35"),
    SelectedListItem<String>(data: "40"),
    SelectedListItem<String>(data: "45"),
    SelectedListItem<String>(data: "50"),
    SelectedListItem<String>(data: "55"),
    SelectedListItem<String>(data: "60"),
    SelectedListItem<String>(data: "65"),
    SelectedListItem<String>(data: "70"),
  ];
              ...
              AppTextField(
                ...
                hint:
                    _ageTextEditingController.text == ""
                        ...
                        : _ageTextEditingController.text,
                isReadOnly: true,
                onTextFieldTap: onAgeTextFieldTap,
              ),
              AppTextField(
  ...
  /// Handles the text field tap for the age
  void onAgeTextFieldTap() async {
    await DropDownState<String>(
      dropDown: DropDown<String>(
        isDismissible: true,
        bottomSheetTitle: const Text(
        ...
        onSelected: (selectedItems) {
          ...
          for (var item in selectedItems) {
            list.add(item.data);
            _ageTextEditingController.text = item.data;
          }
          showSnackBar(list.toString());
        },
        enableMultipleSelection: false,
